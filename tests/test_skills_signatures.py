...
def test_skills_record_includes_college_signatures():
    ...
    # تأكد من وجود أسماء وتراخيص الصور في الـ HTML
    assert '/static/dean_a.png' in html
    assert 'د. أحمد' in html
    assert '/static/stamp_b.png' in html
